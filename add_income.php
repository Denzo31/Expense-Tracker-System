    ...
    <style>
        * {
        ...
        .form-container::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #43a047, #00c853, #4caf50);
        ...
        .welcome-tip {
            background: linear-gradient(45deg, rgba(67, 160, 71, 0.1), rgba(0, 200, 83, 0.1));
            border-radius: 16px;
            padding: 16px 20px;
            margin-bottom: 35px;
...
<body>
    ...
    <div class="form-container">
        <div class="header-section">
            ...
            <p class="subtitle">Every income tracked brings you closer to financial success!</p>
        </div>
        ...
        <form method="post" action="" id="incomeForm" novalidate>
            <div class="source-section">
                ...
                <div class="source-grid">
                    ...
                    <div class="source-option" data-source="Bonus">
                        <div class="source-emoji">🎉</div>
                        <div class="source-name">Bonus</div>
                    </div>
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                >
                <div class="amount-helper">Enter the exact amount you received (e.g., 50000 RWF)</div>
            </div>
            
            <div class="section-title">
                <span>📝</span> Add some details (optional)
            </div>
            <div class="input-group textarea-group">
                <textarea 
                    name="description" 
                    id="description" 
                    placeholder="Add details like project name, bonus reason, or any notes..."
                    rows="3"
                    maxlength="500"
        ...
        <p class="back-link">
            <a href="dashboard.php" aria-label="Back to Dashboard">
                <span>←</span> Back to Your Dashboard
            </a>
        </p>
    </div>
